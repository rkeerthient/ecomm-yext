  ...
  useEffect(() => {
    ...
    searchActions.executeVerticalQuery().then((res) => {
      ...
      setInitCoord({
        ...initCoord,
        latitude:
          res.verticalResults.results[0].rawData.geocodedCoordinate.latitude,
        longitude:
          res.verticalResults.results[0].rawData.geocodedCoordinate.longitude,
      });
    });
  }, []);
  useEffect(() => {
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  mapViewRef.current.animateToRegion(
                    {
                      latitude: category.geocodedCoordinate.latitude,
                      longitude: category.geocodedCoordinate.longitude,
                    },
                    1000
                  )
                }
