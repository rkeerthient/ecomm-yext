  ...
  return (
    <View style={styles.item}>
      <View style={styles.imgContainer}>
        <Image
          resizeMode="contain"
          source={{ uri: data.rawData.primaryPhoto.thumbnails[3].url }}
          style={{
            height: data.rawData.primaryPhoto.thumbnails[3].height,
            width: data.rawData.primaryPhoto.thumbnails[3].width,
          }}
        ></Image>
