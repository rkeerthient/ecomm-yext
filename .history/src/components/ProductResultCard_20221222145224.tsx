  ...
  return (
    <View style={styles.item}>
      <View style={styles.imgContainer}>
        <Image
          resizeMode="contain"
          source={{ uri: data.rawData.primaryPhoto.thumbnails[4].url }}
          style={{
            height: data.rawData.primaryPhoto.thumbnails[4].height,
            width: data.rawData.primaryPhoto.thumbnails[4].width,
          }}
        ></Image>
